...
abstract class PolicyMS_Account
{
    ...
    {
        return openssl_encrypt($token, "AES-128-ECB", PolicyMS_Public::get_plugin_setting(true, 'encryption_key'));
    }

    private static function decrypt_token($token)
    {
        return openssl_decrypt($token, "AES-128-ECB", PolicyMS_Public::get_plugin_setting(true, 'encryption_key'));
    }
